    ...
    class Passport
    {
        ...
        public void InsertarPasaporte(Passport Pasaporte)
        {
            try
            {
                ...
                sqlCommand.Parameters.AddWithValue("@FechaDeEmision", Pasaporte.DateofIssue.ToString("yyyy-MM-dd HH:mm:ss.fff"));
                sqlCommand.Parameters.AddWithValue("@FechaDeVencimiento", Pasaporte.DateofExpiry.ToString("yyyy-MM-dd HH:mm:ss.fff"));
